...
typedef struct {
  /* GICR_CTLR */
  uint32_t icrrcr;
#define GIC_DIST_ICRRCR_UWP BSP_BIT32(31)
#define GIC_DIST_ICRRCR_DPG1S BSP_BIT32(26)
#define GIC_DIST_ICRRCR_DPG1NS BSP_BIT32(25)
#define GIC_DIST_ICRRCR_DPG0 BSP_BIT32(24)
#define GIC_DIST_ICRRCR_RWP BSP_BIT32(4)
#define GIC_DIST_ICRRCR_ENABLE_LPI BSP_BIT32(0)
  uint32_t icriidr;
  uint64_t icrtyper;
#define GIC_DIST_ICRTYPER_AFFINITY_VALUE(val) BSP_FLD64(val, 32, 63)
#define GIC_DIST_ICRTYPER_AFFINITY_VALUE_GET(reg) BSP_FLD64GET(reg, 32, 63)
#define GIC_DIST_ICRTYPER_AFFINITY_VALUE_SET(reg, val) BSP_FLD64SET(reg, val, 32, 63)
#define GIC_DIST_ICRTYPER_COMMON_LPI_AFFINITY(val) BSP_FLD64(val, 24, 25)
#define GIC_DIST_ICRTYPER_COMMON_LPI_AFFINITY_GET(reg) BSP_FLD64GET(reg, 24, 25)
#define GIC_DIST_ICRTYPER_COMMON_LPI_AFFINITY_SET(reg, val) BSP_FLD64SET(reg, val, 24, 25)
#define GIC_DIST_ICRTYPER_CPU_NUMBER(val) BSP_FLD64(val, 8, 23)
#define GIC_DIST_ICRTYPER_CPU_NUMBER_GET(reg) BSP_FLD64GET(reg, 8, 23)
#define GIC_DIST_ICRTYPER_CPU_NUMBER_SET(reg, val) BSP_FLD64SET(reg, val, 8, 23)
#define GIC_DIST_ICRTYPER_DPGS BSP_BIT64(5)
#define GIC_DIST_ICRTYPER_LAST BSP_BIT64(4)
#define GIC_DIST_ICRTYPER_DIRECT_LPI BSP_BIT64(3)
#define GIC_DIST_ICRTYPER_VLPIS BSP_BIT64(1)
#define GIC_DIST_ICRTYPER_PLPIS BSP_BIT64(0)
  uint32_t unused_10;
  uint32_t icrwaker;
#define GIC_DIST_ICRWAKER_CHILDREN_ASLEEP BSP_BIT32(2)
#define GIC_DIST_ICRWAKER_PROCESSOR_SLEEP BSP_BIT32(1)
} gic_redist;
...
typedef struct {
  ...
  /* GICR_ISPENDR0 */
  uint32_t icspisendr[32];
  /* GICR_ICPENDR0 */
  uint32_t icspicendr[32];
  /* GICR_ISACTIVER0 */
  uint32_t icspisar[32];
  /* GICR_ICACTIVER0 */
  uint32_t icspicar[32];
  /* GICR_IPRIORITYR */
  uint32_t icspiprior[8];
